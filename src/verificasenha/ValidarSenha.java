...
public class ValidarSenha {
    ...
    public boolean VerificaSequenciaCharacteres(String login, String senha) {
        boolean apreovado = false;
        if (senha.startsWith(login) || senha.startsWith(login.toLowerCase())) {
            return false;
        } else if (senha.endsWith(login) || senha.endsWith(login.toLowerCase())) {
            return false;
        } else if (senha.contains(login) || senha.contains(login.toLowerCase())) {
            return false;
        } else {
            return true;
        }
